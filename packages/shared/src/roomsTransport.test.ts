...
describe("Shared Rooms request policy", () => {
  ...
  it("preserves the exact route, method, and query allow-list", () => {
    expect(resolveRoomsHumanRequestUrl(request()).href).toBe(
  ...
  it("rejects invalid bearer and CAS input while accepting bounded CAS bytes", () => {
