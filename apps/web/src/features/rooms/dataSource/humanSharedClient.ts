import type { RoomsHumanHttpResponse } from "@t3tools/contracts";
import type { RoomsHumanTransport } from "@t3tools/client-runtime/rooms";
...
export type { RoomsHumanTransport } from "@t3tools/client-runtime/rooms";
