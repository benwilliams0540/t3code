      ...
      <header className="flex flex-wrap items-start gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {/* TODO(rooms): add a health or reachability fact here once native T3 mirroring or project-impact telemetry (benwilliams0540/t3rooms#1) exists; do not imply one before then. */}
            {room.name} · what changed and what needs your decision next.
          </p>
        </div>
        <Button
          className="ml-auto"
