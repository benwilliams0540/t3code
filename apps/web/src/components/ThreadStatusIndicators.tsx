...
/**
 * Elapsed time for a working thread. Self-ticking so only this span re-renders
 * each second rather than its whole row.
 */
export function WorkingDuration({ startedAt }: { startedAt: string | null }) {
