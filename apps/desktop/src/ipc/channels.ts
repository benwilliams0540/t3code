...
export const ROOMS_LOCAL_HTTP_REQUEST_CHANNEL = "desktop:rooms-local-http-request";
export const ROOMS_HUMAN_HTTP_REQUEST_CHANNEL = "desktop:rooms-human-http-request";
